...
type Hook struct {
	...
	FailOnChanges string      `json:"fail_on_changes,omitempty" jsonschema:"enum=never,enum=always,enum=ci" mapstructure:"fail_on_changes" toml:"fail_on_changes,omitempty" yaml:"fail_on_changes,omitempty"`
